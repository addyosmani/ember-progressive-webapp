...
define("ember-progressive-webapp/instance-initializers/browser/clear-double-boot", ["exports"], function (exports) {
  /*globals Ember*/
...
define('ember-progressive-webapp/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"ember-progressive-webapp","environment":"development","baseURL":"","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"ember-progressive-webapp","version":"v0.0.4"},"serviceWorker":{"enabled":true,"debug":true,"fallback":["/offline"]},"exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("ember-progressive-webapp/app")["default"].create({"name":"ember-progressive-webapp","version":"v0.0.4"});
}
